...
Función para cargar todos los archivos *.el que este en la carpeta
~/.emacs.d/lisp.
...
Menú para cada combinación de teclas.
...
Muestra mas opciones en vez de escribir toda la función.
...
Al programar en C++ se te agregarán automaticamente las librerias,
...
Apartado para mostrar los proyectos que tengas, agregué que reconozca
